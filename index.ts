...
const quiz: {
...
} = await inquirer.prompt([
  {
    ...
    type: "list",
    message:
      chalk.bold.yellow("Q1: What is the correct way to check if two values are not equal in TypeScript?"),
  ...
  },
  {
    ...
    type: "list",
    message:
    chalk.bold.yellow("Q2: Which of the following characters is commonly allowed in variable names in Typescript?"),
    choices: ["$", "@", "#", "&"],
  },
  {
    name: "question_3",
    type: "list",
    message:
    chalk.bold.yellow("Q3: Which operator is commonly used for string concatenation in Typescript?"),
    choices: ["+", "-", "*", "/"],
  },
  {
    name: "question_4",
    type: "list",
    message:
    chalk.bold.yellow("Q4: In Typescript, which symbol is commonly used to terminate a statement?"),
    choices: [".", ":", ";", ","],
  },
  {
    name: "question_5",
    type: "list",
    message:
    chalk.bold.yellow("Q5: Which method of Inquirer.js is used to start the prompt interface and receive user input?"),
